...
const USERS: Record<string, { password: string; role: string; name: string; squad: string | null }> = {
  'admin@stayvista.com':           { password: 'StayVista@2026',        role: 'super_admin', name: 'Aditi',           squad: null },
  'sujal.uttekar@stayvista.com':   { password: 'StayVista@2026',        role: 'super_admin', name: 'Sujal',           squad: null },
  'atish.tandkar@stayvista.com':   { password: 'atish.tandkar@123',     role: 'butler',      name: 'Atish Tandkar',   squad: 'Nashik' },
  'kalpesh.ther@stayvista.com':    { password: 'kalpesh.ther@123',      role: 'butler',      name: 'Kalpesh Ther',    squad: 'Alibaug' },
  'kohinoor.shinde@stayvista.com': { password: 'kohinoor.shinde@123',   role: 'butler',      name: 'Kohinoor Shinde', squad: 'Karjat' },
  'manoj.valmiki@stayvista.com':   { password: 'manoj.valmiki@123',     role: 'butler',      name: 'Manoj Valmiki',   squad: 'Lonavala' },
  'nimish@stayvista.com':          { password: 'nimish@123',            role: 'butler',      name: 'Nimish',          squad: 'Alibaug' },
  'ravi.kumar@stayvista.com':      { password: 'ravi.kumar@123',        role: 'butler',      name: 'Ravi Kumar',      squad: 'Lonavala' },
  'vinayak.kharade@stayvista.com': { password: 'vinayak.kharade@123',   role: 'butler',      name: 'Vinayak Kharade', squad: 'Lonavala' },
  'vishal@stayvista.com':          { password: 'vishal@123',            role: 'butler',      name: 'Vishal',          squad: 'Karjat' },
  'butler@stayvista.com':          { password: 'butler@123',            role: 'butler',      name: 'Butler',          squad: null },
}
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Store session in localStorage — auth-context reads this
